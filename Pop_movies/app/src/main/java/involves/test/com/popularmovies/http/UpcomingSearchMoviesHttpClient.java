...
/**
 * Class that creates the retrofit connection to the API for the
 * upcoming movie list on menu item and the movies searched by user on the main
 * Activity through search bar
 */
public class UpcomingSearchMoviesHttpClient {
